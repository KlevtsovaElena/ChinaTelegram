    ...
    let wallpaper = {   
        'image': [
                "./assets/img/fon/fon1.jpg",
                "./assets/img/fon/fon2.png",
                "./assets/img/fon/fon3.jpg",
                "./assets/img/fon/fon4.png",
                "./assets/img/fon/fon5.jpg", 
                "./assets/img/fon/fon6.png",
                "./assets/img/fon/fon7.jpg",
                "./assets/img/fon/fon8.jpg",
                "./assets/img/fon/fon9.jpg",
                "./assets/img/fon/fon10.png",
                "./assets/img/fon/fon11.jpg",
                "./assets/img/fon/fon12.jpg",
                "./assets/img/fon/fon13.jpeg",
                "./assets/img/fon/fon14.jpeg",          
            ],
        'color': [
                "red",
                "blue",
    ...
    if(backgroundLS == null || backgroundLS == '' || backgroundLS == undefined || backgroundLS == 'null'){
        window.localStorage.setItem('background', "./assets/img/fon/fon10.png");
    ...
    function addPost(){
        ...
        if (userName == null || userName == '' || userName == undefined || userName == 'null' || userName.trim() == ''){
            ...
            let url = 'http://localhost:8090/php.php?addpost&name=' + userName + '&message=' + message;
    ...
    function renderposts(){
        ...
        let url = 'http://localhost:8090/php.php?getposts';
        //далее делаем запрос, как на уроке в 3 строки
        let xhr = new XMLHttpRequest();
        xhr.open('GET', url, false);
        xhr.send();
